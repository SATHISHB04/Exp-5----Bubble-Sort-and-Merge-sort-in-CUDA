...
<img width="1064" height="339" alt="image" src="https://github.com/user-attachments/assets/44e89b53-f236-494e-8f87-ff7da3fd2fbe" />


## RESULT:
Thus, the program has been executed using CUDA to compare CPU and GPU implementations of Bubble Sort and Merge Sort. It is observed that CPU Bubble Sort took 0.029543 ms, GPU Bubble Sort took 162.653284 ms, CPU Merge Sort took 0.019806 ms, and GPU Merge Sort took 4.793536 ms. Hence, for this dataset, the CPU implementation performed faster than the GPU implementation.
